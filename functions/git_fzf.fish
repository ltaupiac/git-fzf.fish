# @ltaupiac revision of @ttscoff's version of @max-sixty's revision of @aluxian's
# fish translation of @junegunn's fzf git keybindings
# https://github.com/ltaupiac/git_fzf.fish
...
function git_fzf_key_bindings -d "Set custom key bindings for git+fzf"
	bind ctrl-g,ctrl-s __git_fzf_git_status
	bind ctrl-g,ctrl-b __git_fzf_git_branch
	bind ctrl-g,ctrl-t __git_fzf_git_tag
	bind ctrl-g,ctrl-l __git_fzf_git_log
	bind ctrl-g,ctrl-r __git_fzf_git_remote
end
